...
Once you have edited your function you can use the following command lines to build, test and deploy your function to AWS Lambda from the command line (these examples assume the project name is *HXIM.File*):
...
Execute unit tests
```
    cd "HXIM.File/test/HXIM.File.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "HXIM.File/src/HXIM.File"
